...
Map<String, dynamic> _$OAuthFlowsOpenApiToJson(OAuthFlowsOpenApi instance) => <String, dynamic>{
...
Map<String, dynamic> _$OAuthFlowOpenApiToJson(OAuthFlowOpenApi instance) => <String, dynamic>{
