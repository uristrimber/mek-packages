...
Map<String, dynamic> _$ItemPathOpenApiToJson(ItemPathOpenApi instance) => <String, dynamic>{
...
Map<String, dynamic> _$OperationOpenApiToJson(OperationOpenApi instance) => <String, dynamic>{
  ...
  'responses': instance.responses.map((k, e) => MapEntry(k.toString(), e.toJson())),
...
ParameterOpenApi _$ParameterOpenApiFromJson(Map json) =>
    $checkedCreate('ParameterOpenApi', json, ($checkedConvert) {
      final val = ParameterOpenApi(
        ...
        schema: $checkedConvert('schema', (v) => v == null ? null : SchemaOrRef.fromJson(v as Map)),
...
Map<String, dynamic> _$ParameterOpenApiToJson(ParameterOpenApi instance) => <String, dynamic>{
  'description': ?instance.description,
...
Map<String, dynamic> _$RequestBodyOpenApiToJson(RequestBodyOpenApi instance) => <String, dynamic>{
  'description': ?instance.description,
  'required': instance.required,
...
Map<String, dynamic> _$ResponseOpenApiToJson(ResponseOpenApi instance) => <String, dynamic>{
  'description': instance.description,
...
Map<String, dynamic> _$ComponentsOpenApiToJson(ComponentsOpenApi instance) => <String, dynamic>{
